class AdminSite::TypeAdminsController < ApplicationController
  ...
  def index
    @admin_site_type_admins = AdminSite::TypeAdmin.all
  end
  ...
  def new
    @admin_site_type_admin = AdminSite::TypeAdmin.new
  end
  ...
  def create
    begin
      @admin_site_type_admin = AdminSite::TypeAdmin.new(admin_site_type_admin_params)
  ...
  private
    ...
    def set_admin_site_type_admin
      @admin_site_type_admin = AdminSite::TypeAdmin.find(params[:id])
    end
